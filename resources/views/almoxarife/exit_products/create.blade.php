...
@section('page-title', 'Nova Saída de Produto')
@section('page-subtitle', 'Registrar saída do estoque')
...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form action="{{ route('almoxarife.exit_products.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="type" id="type"
                               ...
                               value="{{ old('type') }}" placeholder="Ex.: Consumo, Transferência...">
                        @error('type')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
