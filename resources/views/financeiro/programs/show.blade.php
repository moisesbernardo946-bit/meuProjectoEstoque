{{-- resources/views/financeiro/programs/show.blade.php --}}
@extends('layouts.financeiro')

@section('title', 'Programação ' . $program->code)
@section('page-title', 'Programação de Compra ' . $program->code)
@section('page-subtitle', 'Análise e aprovação financeira')
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('financeiro.programs.index') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h6 class="mb-0">Anexos da programação</h6>
        </div>
        <div class="card-body">
            @if ($program->attachments->isEmpty())
                    ...
                    @foreach ($program->attachments as $att)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span>{{ $att->original_name ?? basename($att->path) }}</span>
                            </div>
                            <div class="d-flex gap-2">
                                {{-- Abrir/visualizar --}}
