...
@section('page-subtitle', 'Análise das programações enviadas pelo comprador')

@section('content')
    {{-- FILTROS --}}
    <div class="card shadow-sm mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('diretor.diretorprograms.index') }}" class="row g-3 align-items-end">
                <div class="col-md-3">
                    ...
                    <select name="status" class="form-select form-select-sm">
                        ...
                        <option value="concluido" {{ $status === 'concluido' ? 'selected' : '' }}>Concluídas</option>
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="search" class="form-control form-control-sm"
                        placeholder="Código da programação, código da requisição, comprador..." value="{{ $search }}">
                </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-light d-flex justify-content-between align-items-center">
            <strong>Programações de compra</strong>
                        ...
                        <tbody>
                            @foreach ($programs as $program)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            ...
                                            switch ($program->status) {
                                                case 'pendente':
                                                    $cls = 'secondary';
                                                    $label = 'Pendente (Compras)';
                                                    break;
                                                case 'aprovado':
                                                    $cls = 'info';
                                                    $label = 'Aprovado (Compras)';
                                                    break;
                                                case 'concluido':
                                                    $cls = 'success';
                                                    $label = 'Concluído';
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('diretor.diretorprograms.show', $program->id) }}"
                                            class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-eye"></i> Ver / Analisar
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
