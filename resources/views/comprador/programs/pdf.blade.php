...
<head>
    ...
    <style>
        ...
        .company-info b { display:block; font-weight:700; margin-bottom:4px; }
        .company-info small { display:block; color:#333; }
        ...
        .main-table th { font-weight: 700; background: #fff; }
        ...
        .totals .row .k { display: table-cell; }
        .totals .row .v { display: table-cell; text-align: right; width: 120px; }
        .totals .row.total { font-weight:700; border-top:2px solid #000; }

        /* assinaturas */
        .signatures { margin-top: 70px; width:100%; }
        .sig { width: 30%; display:inline-block; text-align:center; }
        .sig .line { border-top:1px solid #000; margin-top:36px; padding-top:6px; }
    </style>
</head>
<body>
    <div class="sheet">
        ...
        <div class="signatures">
            <div class="sig"><div class="line"></div><div>Gestor Suprimentos</div></div>
            <div class="sig"><div class="line"></div><div>Gestor Administrativo</div></div>
            <div class="sig"><div class="line"></div><div>Financeiro</div></div>
        </div>
    </div>
</body>
</html>
